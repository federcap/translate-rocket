...
// Public functions for theme and plugin developers: trrocket_current_language(), trrocket_default_language().
require_once TRROCKET_PATH . 'src/functions.php';
